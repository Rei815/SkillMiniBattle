...
const std::string		CFalloutTopicBG::m_file_name = "data\\Textures\\fallout_select_bg.png";
const int               CFalloutTopicBG::m_width = 410;
const int               CFalloutTopicBG::m_height = 254;
const vivid::Rect       CFalloutTopicBG::m_rect = vivid::Rect{ 0, 0, m_width, m_height };
const vivid::Vector2    CFalloutTopicBG::m_scale = vivid::Vector2(0.5f, 0.5f);
