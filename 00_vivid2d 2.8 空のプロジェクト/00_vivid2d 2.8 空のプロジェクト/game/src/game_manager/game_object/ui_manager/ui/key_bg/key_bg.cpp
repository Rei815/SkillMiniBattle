...
const int               CKeyBG::m_width = 1000;
const int               CKeyBG::m_height = 750;
const vivid::Rect       CKeyBG::m_rect = vivid::Rect{ 0, 0, m_width, m_height };
const vivid::Vector2    CKeyBG::m_scale = vivid::Vector2(0.2f, 0.2f);
const vivid::Vector2    CKeyBG::m_anchor = vivid::Vector2((m_width * m_scale.x) / 2, (m_height * m_scale.y) / 2);
