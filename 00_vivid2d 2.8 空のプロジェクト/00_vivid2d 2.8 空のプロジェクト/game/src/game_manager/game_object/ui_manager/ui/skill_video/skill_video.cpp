...
const std::string CSkillVideo::m_skill_video_file_name[] =
{
		...
		"data\\video_test.mp4",
		"data\\skill_movie_dash_test.mp4",
		"data\\skill_movie_spawnwall_test.mp4",
		"data\\skill_movie_barrier_test.mp4",
		"data\\skill_movie_gravityarea_test.mp4",
		"data\\skill_movie_invisible_test.mp4",
		"data\\video_test.mp4",
		"data\\video_test.mp4",
		"data\\video_test.mp4",
		"data\\skill_movie_ogrecontrol_test.mp4",
		"data\\video_test.mp4",
		"data\\video_test.mp4",
		"data\\video_test.mp4",
		"data\\skill_movie_strongwind_test.mp4",
		"data\\skill_movie_hidetopic_test.mp4",
		"data\\video_test.mp4"
};
