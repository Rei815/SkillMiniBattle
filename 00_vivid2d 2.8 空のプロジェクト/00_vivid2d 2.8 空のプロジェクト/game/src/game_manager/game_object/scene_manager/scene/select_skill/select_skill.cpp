...
void CSelectSkill::Finalize(void)
{
    ...
    CUIManager::GetInstance().Delete(UI_ID::MENU_BG);
    CUIManager::GetInstance().Delete(UI_ID::MENU_POSTER);
    CUIManager::GetInstance().Delete(UI_ID::SKILL_NAME);
    CUIManager::GetInstance().Delete(UI_ID::SCENE_TITLE);
}
...
void CSelectSkill::MoveCursor(void)
{
    ...
    vivid::DrawText(1, "", vivid::Vector2().ZERO);
