...
void CPlayer::Impact(const CVector3& hit_position, const CVector3& direction, float power)
{
    ...
    //‚’¼•ûŒü‚Ì‘¬“x‚ÍÅŒã‚ÉŒvŽZ‚·‚é‚Ì‚ÅAˆê“xƒ[ƒ‚É‚·‚é
    TempVelocity.y = 0.0f;
    //ƒxƒNƒgƒ‹‚Ì‘å‚«‚³‚ð‚Q‚É‚·‚é
    TempVelocity = TempVelocity.Normalize() * 2.0f;
    //’e‚Ì‘¬“xƒxƒNƒgƒ‹‚Ì‘å‚«‚³‚ð‚P‚É‚µ‚Ä‰ÁŽZ‚·‚éi“–‚½‚Á‚½Œü‚«‚Æ’e‚Ì‘¬“x‚ª^‹t‚Ìê‡‚ÉA…•½•ûŒü‚Ì‘¬“x‚ª‘Å‚¿Á‚³‚ê‚é‚Ì‚ð–h‚®‚½‚ßj
    TempVelocity += direction;
    //‚’¼•ûŒü‚Ì‘¬“x‚ÍÅŒã‚ÉŒvŽZ‚·‚é‚Ì‚ÅAÄ‚Ñƒ[ƒ‚É‚·‚é
    TempVelocity.y = 0.0f;
    //‘¬“x‚ð”{—¦‚Å’²®‚·‚é‚½‚ßAƒxƒNƒgƒ‹‚Ì‘å‚«‚³‚ð‚P‚É‚·‚é
    TempVelocity = TempVelocity.Normalize();
    //‚’¼•ûŒü‚ÌƒxƒNƒgƒ‹‚ð’Ç‰Á
    TempVelocity.y = 0.2f;
    //‘¬“x‚ðƒxƒNƒgƒ‹‚Æ‚»‚Ì”{—¦‚ÅƒZƒbƒg‚·‚é
