...
void CPlane::Draw(const CMatrix& mat)
{
	...
	vertices[0].pos = CVector3(-width_half, -height_half, 0.0f) * mat;
	...
	vertices[1].pos = CVector3(width_half, -height_half, 0.0f) * mat;
	...
	vertices[2].pos = CVector3(width_half, height_half, 0.0f) * mat;
	...
	vertices[3].pos = CVector3(-width_half, height_half, 0.0f) * mat;
